 ...
 */
export declare class YMapControlCommonButton extends DomEntity<YMapControlCommonButtonProps, HTMLButtonElement> {
    protected _createDom(): {
        element: HTMLButtonElement;
        container: HTMLElement;
    };
    protected _updateDom(element: HTMLButtonElement, props: Partial<YMapControlCommonButtonProps>, init?: boolean): void;
}
/**
